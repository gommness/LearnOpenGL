...
_POST_PROCESSING_EXERCISE_OBJ = PostProcessingExercise.o ${_SHADERS_OBJ} ${_GAMEOBJECTS_OBJ} ${_ASSIMP_OBJ} ${_DEBUG_OBJ}
POST_PROCESSING_EXERCISE_OBJ = $(addprefix ${OBJD}/,${_POST_PROCESSING_EXERCISE_OBJ})
POST_PROCESSING_EXERCISE_INCLUDE = 
POST_PROCESSING_EXERCISE_REQUISITES = ${POST_PROCESSING_EXERCISE_OBJ} ${SHADER_CODE}
...
ADVANCED_TARGETS += ${POST_PROCESSING_EXERCISE_TARGET}
...
${POST_PROCESSING_EXERCISE_TARGET}: ${POST_PROCESSING_EXERCISE_REQUISITES}
	${CC} ${CFLAGS} -o ${BUILD}/$@ ${POST_PROCESSING_EXERCISE_OBJ} ${MODEL_EXERCISE_LIBS}
